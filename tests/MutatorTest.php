...
class MutatorTest extends \PHPUnit_Framework_TestCase {
    ...
    {
        $callable = 'Ingenious\Eloquence\Tests\MutatorDummyInstantiable@multiply';
    ...
    {
        $callable = 'Ingenious\Eloquence\Tests\MutatorDummyInstantiable@divide';
    ...
    public function it_accepts_array_of_methods()
    {
        $callable = [
            ...
            'strtoupper',  // ' RED FOX'
            'clip:4',      // ' RED '
            'Ingenious\Eloquence\Tests\MutatorDummyInstantiable@repeat:3',
        ];
    ...
    public function wrongCallables()
    {
        return [
            ...
            ['StdClass@jibberrish'],
            ['wrong_function'],
            ['Ingenious\Eloquence\Tests\MutatorDummyNotInstantiable@repeat:3'],
            ['Ingenious\Eloquence\Tests\MutatorDummyRequiredArgs@repeat:3'],
            ['Ingenious\Eloquence\Tests\MutatorDummyInstantiable@protectedMethod'],
        ];
    }
}
